...
#     :param mosmix: A dictionary containing the df_mosmix data for each parameter.
#     :param icon: A dictionary containing the df_icon data for each parameter.
#     :param icon_eu: A dictionary containing the df_icon_eu data for each parameter.
...
#                 save_pd_as_json(f"{name}/{param}", df)
#
...
#     :return:
#     """
#     print(f"{datetime.now()} - sort_data.py - create_mixed_dxf_for {parameter}") if DEBUG_SORT_DATA else None
#
#     df = DataFrame()
#
...
#     :return:
#     """
#     print(f"{datetime.now()} sort_data.py - get_nights_only_as_list\n{df}") if DEBUG_SORT_DATA else None
#
...
#
#     if DEBUG_SORT_DATA:
#         print("sort_data.py - get_nights_only_as_list")
#         print(f"tonight:\n{tonight}")
#         print(f"tomorrow:\n{tomorrow}")
#         print(f"tomorrow2:\n{tomorrow2}")
#
