...
def explore_dataframe(df: DataFrame):
    ...
    print_function_info(_filename, "explore_dataframe") if DEBUG_DF_UTILS else None
...
def print_groups(grouped_df: DataFrameGroupBy):  #
    print_function_info(_filename, "print_groups")  if DEBUG_DF_UTILS else None
...
def explore_group(df: DataFrame | DataFrameGroupBy) -> None:
    ...
    Takes a DataFrame as input and does not return anything.
    """
    print_function_info(_filename, "explore_group") if DEBUG_DF_UTILS else None
